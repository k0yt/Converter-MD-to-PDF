...
Аналогично задаче 1, объект S2 берет право у Y на доступ к объекту S. Затем S1 создает новый субъект ABOBA со следующими правами: TAKE + GRANT, и дает права GRANT для объекта S2, чтобы тот мог работать с субъектом ABOBA. Объект S2, имея права на объект S и права GRANT для ABOBA, предоставляет субъекту ABOBA права на объект S. S1, будучи владельцем ABOBA, наследует права на S у субъекта ABOBA.
